...
public class Script extends AbstractAction {
	...
	public Script(String name, ScriptCache scriptCache, BufferedReader reader) throws ParseError, ValidationError, IOException {
		this.name = name;
	...
	public Script load(String name) throws ParseError, ValidationError, IOException {
